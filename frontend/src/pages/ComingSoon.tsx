      ...
      <div className="relative glass rounded-3xl p-6 sm:p-12 max-w-md w-full">
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full glass rounded-xl px-4 py-3 text-sm text-slate-700 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-600 outline-none focus:border-violet-400/40 dark:focus:border-violet-500/40"
          />
