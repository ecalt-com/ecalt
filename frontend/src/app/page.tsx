...
const FEATURED: Pick<Journey, 'id' | 'title' | 'description' | 'icon' | 'difficulty' | 'tags' | 'estimated_hours' | 'steps'>[] = [
  {
    ...
    steps: Array(10).fill(null),
  },
  {
    id: 'journey-ml',
    title: 'How Machines Actually Learn',
    description: 'Strip away the hype and understand the math, patterns, and intuition behind AI.',
    icon: '🤖',
    difficulty: 'intermediate',
    estimated_hours: 4,
    tags: ['AI', 'math', 'tech'],
    steps: Array(12).fill(null),
  },
  {
    id: 'journey-rockets',
    title: 'From Gunpowder to Orbit',
    description: "Newton's laws meet engineering to explain why rockets can escape Earth's gravity.",
    icon: '🚀',
    difficulty: 'beginner',
    estimated_hours: 2.5,
  ...
  },
  {
    ...
    description: 'Why do some chords sound sad? Why does a melody feel unresolved? Discover the physics of beauty.',
    icon: '🎵',
    difficulty: 'beginner',
    estimated_hours: 3,
  ...
  },
  {
    ...
    description: 'Atmospheric physics, feedback loops, and what the data actually says — no politics, just science.',
    icon: '🌍',
    difficulty: 'intermediate',
    estimated_hours: 3.5,
  ...
  },
  {
    ...
    description: 'Interest, inflation, investing — the financial concepts school forgot to teach you.',
    icon: '💰',
    difficulty: 'beginner',
    estimated_hours: 2,
    tags: ['finance', 'life skills'],
    steps: Array(7).fill(null),
  },
]
...
const HOW_IT_WORKS = [
  {
    num: '01',
    title: 'Ask Anything',
    desc: 'Type your question in plain language. No syllabi, no categories — just your curiosity.',
  ...
  },
  {
    ...
    desc: "ECALT's AI breaks your question into a step-by-step capability path, adapted to your level.",
  ...
  },
  {
    ...
    desc: 'Work through guided concepts, practices, and challenges — at your own pace, on any device.',
...
export default function HomePage() {
  ...
  const handleExplore = (question: string) => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute bottom-1/4 right-1/5 w-[400px] h-[400px] bg-cyan-500/8 rounded-full blur-[120px] animate-glow-pulse"
          style={{ animationDelay: '1.5s' }}
        />
        <div
          className="absolute top-2/3 left-1/2 w-[300px] h-[300px] bg-amber-500/5 rounded-full blur-[100px] animate-glow-pulse"
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen px-4 py-28 text-center">
        ...
        {/* Headline */}
        <h1
          className="animate-in delay-100 text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.05] tracking-tight mb-6 max-w-4xl"
          style={{ opacity: 0 }}
        >
          Turn curiosity
          <br />
        ...
        {/* Subtext */}
        <p
          className="animate-in delay-200 text-lg md:text-xl text-slate-400 max-w-xl mb-12 leading-relaxed"
          style={{ opacity: 0 }}
        >
        ...
        <div className="animate-in delay-300 w-full max-w-2xl" style={{ opacity: 0 }}>
          <CuriosityInput onExplore={handleExplore} />
        </div>
      ...
      <section className="relative px-4 py-24 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {HOW_IT_WORKS.map(({ num, title, desc, color, border, numColor }) => (
            <div key={num} className={`relative rounded-2xl p-6 bg-gradient-to-b ${color} border ${border}`}>
              <div className={`text-5xl font-bold mb-4 ${numColor} opacity-60`}>{num}</div>
      ...
      <section className="relative px-4 py-24 text-center">
        <div className="max-w-2xl mx-auto glass rounded-3xl p-12">
          ...
          <p className="text-slate-500 mb-8">
            No account needed. Just ask your first question.
          </p>
          <CuriosityInput onExplore={handleExplore} />
        </div>
      </section>
